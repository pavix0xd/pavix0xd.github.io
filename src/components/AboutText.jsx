  ...
  return (
    <main className="relative h-screen overflow-hidden px-4">
      ...
      >
        ...
        >
          Curious right? Yeah I build Full - stacks too. Flutter? you guessed correct, Flutter too.
          <span className="text-[#6F8695]">Not a typical "Hello World!" guy</span> Give me a challenge or a good paycheck and watch the magic happen :3
        </p>
      </motion.div>
